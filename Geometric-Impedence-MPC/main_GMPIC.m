...
%% Initial g(0)) ===== ===== ===== ===== ===== ===== =====:
DIR = helper.declareSection("gmpic", "init_wam_v2", SAVE_CONSOLE, CLEAR_OUTPUT, CLOSE_WINDOW);
% --- 
...
data = model.dynamic_sim(list_of_thetas(:,1), list_of_thetas(:,2:end), dT, FB_Ctrl_CONFIG);
% compute fwd traj:
